<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="learnFirst.login" %>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container d-flex align-items-center">
           ...
           <p class="button-custom order-lg-last mb-0"><a href="signup.aspx" class="btn btn-secondary py-2 px-3">Sign Up</a></p>
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav mr-auto">
	        	<li class="nav-item"><a href="index.aspx" class="nav-link pl-0">Home</a></li>
  ...
  <div class="form-label-group">
    ...
    <input type="password" id="inputPassword" class="form-control" placeholder="Password" required />
              ...
              <div class="form-label-group">
      <a class="btn-secondary py-2 px-3" href="#">Forgot password?</a>
